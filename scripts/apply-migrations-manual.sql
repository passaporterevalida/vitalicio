-- Script para aplicar migrações manualmente no Supabase Dashboard
...
-- 1. Criar tabela para gerenciar e-mails autorizados
...
-- 3. Políticas de segurança (apenas service_role pode gerenciar)
...
-- 6. Função para adicionar e-mail autorizado
...
-- 7. Função para remover e-mail autorizado
...
-- 8. Tabela para log de tentativas de acesso não autorizado
...
-- 13. Inserir e-mails de exemplo (substitua pelos reais)
...
-- 14. Inserir domínios autorizados (exemplo)
...
-- 16. Testar função de validação
SELECT 'Teste de validação:' as status;
SELECT 
  'admin@revalidaquest.com' as email,
  public.is_email_authorized('admin@revalidaquest.com') as autorizado;
